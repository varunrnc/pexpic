        ...
        <div class="row justify-content-center align-items-center g-3 h-100">
            ...
            <div class="col-md-5 border-start border-warning border-5">
                <div class="card">
                    ...
                    <form>
                <h3 class="fs-2 text-center mb-4">Create Account</h3>
                    <div class="form-group mb-3">
                        <label for="fullname" class="fs-5 ">Full Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="fullname"  aria-describedby="emailHelp" placeholder="Enter Your Full Name">
                        
                    </div>
                    <div class="form-group mb-3">
                        <label for="mobile" class="fs-5 ">Mobile No. <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="mobile"  aria-describedby="emailHelp" placeholder="Enter Your Mobile No.">
                    ...
                    <button type="submit" class="theme-btn d-block w-100 fs-4 my-3">SignUp</button>
                    <a href="{{ route('user.login') }}" class="fs-5">Already Have an Account? <strong class="text-danger">Sign In</strong></a>
                </form>
                    </div>
                </div>
            </div>
