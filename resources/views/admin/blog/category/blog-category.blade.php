    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.blog.category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="blogCategoryImage" class="form-label">Choose Image</label>
                    <input class="form-control" type="file" name="blog_category_image" id="blogCategoryImage"
            ...
            <table class="table">
                ...
                @foreach ($categories as $key => $category)
                    <tr>
                        ...
                        <td><img src="{{ asset('public/uploads/blog/categories/' . $category->category_image) }}" alt="category"
...
@section('page-js')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const imageInput = document.getElementById('blogCategoryImage');
            ...
            switches.forEach(function(toggle) {
                toggle.addEventListener('change', function() {
                    ...
                    "{{ route('admin.blog.category.status', ['id' => ':id']) }}";
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    const categoryId = this.dataset.id;
                    const deleteCategory = "{{ route('admin.blog.category.delete', ['id' => ':id']) }}";
